(function (a) {
    ...
    c.prototype = {constructor: c, setOptions: function (c, d) {
        ...
        if ("undefined" == typeof c.startDate && "undefined" == typeof c.endDate && a(this.element).is("input[type=text]")) {
            var i = a(this.element).val(), j = i.split(this.separator);
        ...
        if (this.element.is("input") && this.element.val().length) {
            var a = this.element.val().split(this.separator), c = null, d = null;
        ...
        var c = a(b.target).attr("data-title"), d = c.substr(1, 1), e = c.substr(3, 1), f = a(b.target).parents(".calendar");
        ...
        var d, e, f = a(c.target).attr("data-title"), g = f.substr(1, 1), h = f.substr(3, 1), i = a(c.target).parents(".calendar");
        if (i.hasClass("left")) {
        ...
        if (this.singleDatePicker && i.hasClass("left") ? e = d.clone() : this.singleDatePicker && i.hasClass("right") && (d = e.clone()), i.find("td").removeClass("active"), d.isSame(e) || d.isBefore(e))a(c.target).addClass("active"), this.startDate = d, this.endDate = e, this.chosenLabel = this.locale.customRangeLabel; else if (d.isAfter(e)) {
        ...
        var c = a(b.target).closest(".calendar").hasClass("left"), d = c ? "left" : "right", e = this.container.find(".calendar." + d), f = parseInt(e.find(".monthselect").val(), 10), g = e.find(".yearselect").val();
        this[d + "Calendar"].month.month(f).year(g), this.updateCalendars()
    }, updateTime: function (b) {
        var c = a(b.target).closest(".calendar"), d = c.hasClass("left"), e = parseInt(c.find(".hourselect").val(), 10), f = parseInt(c.find(".minuteselect").val(), 10);
        ...
        var f, g = b([c, a, 1]), h = b(g).subtract("month", 1).month(), i = b(g).subtract("month", 1).year(), j = b([i, h]).daysInMonth(), k = g.day(), l = [];
        for (f = 0; 6 > f; f++)l[f] = [];
        var m = j - k + this.locale.firstDay + 1;
        m > j && (m -= 7), k == this.locale.firstDay && (m = j - 6);
        var n, o, p = b([i, h, m, 12, e]);
        for (f = 0, n = 0, o = 0; 42 > f; f++, n++, p = b(p).add("hour", 24))f > 0 && n % 7 === 0 && (n = 0, o++), l[o][n] = p.clone().hour(d), p.hour(12);
        return l
